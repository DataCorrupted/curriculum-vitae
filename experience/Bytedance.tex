...
\ifx\lang\eng
	\begin{rSubsection}{Bytedance}{\timeInterval}{Research Intern}{Beijing, China}
		...
		\item \textit{\textbf{IntEgrity: finding integer errors by targeted fuzzing}} submitted to CODASPY 2020, currently under review.
	\end{rSubsection}
\else
	\begin{rSubsection}{字节跳动}{\timeInterval}{安全实验室实习生}{中国，北京}
		...
		\item \textit{\textbf{IntEgrity: finding integer errors by targeted fuzzing}} 已提交至 CODASPY 2020，正在被审议。
	\end{rSubsection}
\fi
